<?php
    ...
    $sql = "SELECT * from post WHERE type = 'Miscellaneos'";
    ...
    $sql2 = "SELECT COUNT(type) as total FROM post WHERE type = 'Miscellaneos'";
...
<html lang="en">
    <head>
        ...
        <title>Yotunities | Miscellaneos</title>
      ...
      <div class="container-fluid post-margin bg-header">
        <div class="row">
          <div class="col-md-12 mt-4 mb-0">
            <h1 class="text-left t-blue mb-4 ">Miscellaneos(<?php echo htmlspecialchars($num_rows2); ?>)</h1>
          </div>
        </div>
      </div>
