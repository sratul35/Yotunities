<?php
    ...
    if(isset($_POST["apply"])){
      header('location: mail/pra.php');
    }

    $sql = "SELECT * from post WHERE type = 'Scholarship'";
    ...
    $sql2 = "SELECT COUNT(type) as total FROM post WHERE type = 'Scholarship'";

    $result2 = mysqli_query($conn, $sql2);

    $values2 = mysqli_fetch_assoc($result2);

    $num_rows2 = $values2['total']; //total number of rows in the table post
...
<html lang="en">
    <head>
        ...
        <title>Yotunities | Scholarship</title>
        <link rel="stylesheet" href="posst.css">
      ...
      <div class="container-fluid post-margin bg-header">
        <div class="row">
          <div class="col-md-12 mt-4 mb-0">
            <h1 class="text-left t-blue mb-4 ">Scholarship(<?php echo htmlspecialchars($num_rows2); ?>)</h1>
          </div>
        </div>
      </div>
