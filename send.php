<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $sql = "INSERT INTO apply (o_email, id, subject, message, admin_id) VALUES ('$organizerMail', '$user_id', '$subject', '$message', '1')";
        ...
        $mail->setFrom("yotunities@gmail.com", "Yotunities");
        $mail->addAddress("$organizerMail");
        // cc 
        ...
        // add more body
        $mail->Body .= "<br><br>";
        $mail->Body .= "I am $name. I am interested in your event. I would like to apply for this event. Please let me know if there is any vacancy.";
        $mail->Body .= "<br><br>";
