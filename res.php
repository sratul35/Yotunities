<?php
    ...
    mysqli_free_result($result); // free the $result from memory (good practise)


    // get the data from the array and store them in a variable
      ...
      <div class="container-fluid post-margin bg-header">
        <div class="row">
          <div class="col-md-12 mt-4 mb-0">
            <h1 class="text-left t-blue mb-4 ">Yotunities</h1>
          </div>
        </div>
      </div>
