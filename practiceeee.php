          ...
          if(in_array($fileActualExt, $allowed)){
              ...
              if($fileError === 0){
                  ...
                  if($fileSize < 5000000){
                      ...
                      $sql = "INSERT INTO post (title, description, appProcess, eligibilities, benefits, type, fundingType, deadline,sDate, eDate, featuredImage,appliedLink, location, organizers, organizerPhone, organizerMail ,tags,id)
                      VALUES ('$title', '$description', '$process', '$eligibility', '$benefits', '$type', '$funding', '$deadline', '$start_date', '$end_date', '$fileDestination ', '$link', '$location', '$organizer', '$organizerPhone', '$organizerMail', '$tags', '$user_id')";
...
<html lang="en">
    <head>
        ...
        <title>Yotunities | Post Opportunities</title>
      ...
      <div class="container-fluid form p-2">
        ...
        <!-- title input box -->
          <div class="form-group p-1">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" placeholder="Enter title" name="title" value="<?php echo $_POST['title']; ?>">
            </div>
          </div>
