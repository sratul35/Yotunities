<?php
    ...
    $sqll = "SELECT * from post ORDER by eDate ASC";

    $resultt = mysqli_query($conn, $sqll); // get the result set (set of rows)

    $arr = mysqli_fetch_all($resultt, MYSQLI_ASSOC); // fetch the resulting rows as an array
      ...
      <div class="container-fluid post-margin bg-header">
        <div class="row">
          <div class="col-md-12 mt-4 mb-0">
            <h1 class="text-left t-blue mb-4 ">Near Deadline</h1>
          </div>
        </div>
      </div>
