<?php
    ...
    $sql = "SELECT * from post WHERE type = 'Fellowship'";

    $sql2 = "SELECT COUNT(type) as total FROM post WHERE type = 'Fellowship'";
...
<html lang="en">
    <head>
        ...
        <title>Yotunities | Fellowship</title>
      ...
      <div class="container-fluid post-margin bg-header">
        <div class="row">
          <div class="col-md-12 mt-4 mb-0">
            <h1 class="text-left t-blue mb-4 ">Fellowship(<?php echo htmlspecialchars($num_rows2); ?>)</h1>
          </div>
        </div>
      </div>
